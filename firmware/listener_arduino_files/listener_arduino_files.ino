...
// CS=IO10, SCK=IO12, MISO=IO13, MOSI=IO11. The dev/Hub board used SCK=2/MISO=11/MOSI=1;
// set BOARD_DEV 1 to flash that board instead.
#define BOARD_DEV 0
#if BOARD_DEV
...
#else
  #define NAND_CS   10   // CS_NAND   (IO10)
  #define NAND_SCK  12   // SCK / CLK (IO12)
  #define NAND_MISO 13   // DO  (flash -> ESP, IO13)
  #define NAND_MOSI 11   // DI  (ESP -> flash, IO11)
#endif
// -----------------------------------------------------------------------------
